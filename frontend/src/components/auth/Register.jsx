    ...
    <div className="min-h-screen flex relative overflow-hidden bg-gradient-to-r from-emerald-50 via-cyan-50 to-blue-50">
        ...
        <div className="max-w-md relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-10 leading-relaxed text-gray-700">
              Create an account to access comprehensive healthcare services and
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <motion.div
          ...
          animate="visible"
        >
          <motion.div className="backdrop-blur-sm bg-white/80 rounded-3xl p-8 sm:p-10 shadow-xl border border-white/50">
              ...
              <AnimatePresence mode="wait" custom={step}>
                {step === 1 && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    {/* Changed from grid-cols-2 md:grid-cols-4 to grid-cols-1 md:grid-cols-2 for more width */}
                  ...
                  >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        >
                          ...
                          <div className="relative p-4 flex flex-col items-center">
                            ...
                            {formData.role === "patient" && (
                              <svg
                                className="absolute top-2 right-2 w-5 h-5 text-cyan-600"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                              >
                                <path
                        ...
                        <div
                          ...
                          onClick={() =>
                            setFormData({ ...formData, role: "laboratory" })
                          }
                        >
                          <div
                            className={`absolute inset-0 ${
                        ...
                        <div
                          ...
                          onClick={() =>
                            setFormData({ ...formData, role: "pharmacy" })
                          }
                        >
                          <div
                            className={`absolute inset-0 ${
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={
                          validateStep2() && !isLoading ? { scale: 0.98 } : {}
                        }
                      >
                        <span className="relative flex items-center z-10">
                          {isLoading ? (
